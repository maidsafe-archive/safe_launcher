...
class AuthUtils extends Utils {
  ...
  authoriseApp(authPayload, config, authRes) {
    ...
    return this.request(this.HTTP_METHOD.POST, CONSTANTS.API.AUTH, null, authPayload, config);
  }

  revokeApp(authToken) {
    return this.request(this.HTTP_METHOD.DELETE, CONSTANTS.API.AUTH, authToken);
  }
  ...
  isAuthTokenValid(config) {
    return this.request(this.HTTP_METHOD.GET, CONSTANTS.API.AUTH, null, config);
  }
}
