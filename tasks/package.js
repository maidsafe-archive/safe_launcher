...
var platformName = config.platform === 'win32' ? config.platform.slice(0, -2) : config.platform;
var packageNameWithVersion = BINARY_NAME + '-v' + appVersion + '-' + platformName + '-' + os.arch();
