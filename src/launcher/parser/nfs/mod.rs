    ...
    Ok(match action_str {
            ...
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    create_dir_v1_0::CreateDir::decode(d)
                                                }),
                                                "")))
                }
        ...
        "delete-dir" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    delete_dir_v1_0::DeleteDir::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
        ...
        "modify-dir" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    modify_dir_v1_0::ModifyDir::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
        ...
        "create-file" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    create_file_v1_0::CreateFile::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
        ...
        "delete-file" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    delete_file_v1_0::DeleteFile::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
        ...
        "modify-file" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    modify_file_v1_0::ModifyFile::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
        ...
        "get-file" => {
            match version {
                1.0 => {
                    Box::new(try!(parse_result!(decoder.read_struct_field("data", 0, |d| {
                                                    get_file_v1_0::GetFile::decode(d)
                                                }),
                                                "")))
                }
                _ => return version_err,
