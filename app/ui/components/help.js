    ...
    return (
      <div className="help">
        <div className="help-b">
          ...
          <p className="p">
            The SAFE Network and Launcher are still in test phases and may
            only work if you are using the lastest version.
          </p>
          ...
          <p className="p">
            ...
            Here you&rsquo;ll find tutorials on setting up and using the Launcher
            and example apps from MaidSafe.
          </p>
          <ul className="list">
            <li><a
              href={undefined}
          ...
          <p className="p">
            You can join the discussion on the
            &nbsp;<a
              href={undefined}
              onClick={e => {
                e.preventDefault();
            ...
            >Community forum</a>.
            If you&rsquo;d like to contribute to the code or have found
            any issues, you can find us on&nbsp;
            <a
              href={undefined}
              onClick={e => {
                e.preventDefault();
